	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/peimission/findAll">资源权限管理</a></li>
									...
									<c:forEach items="${list}" var="p">
										<tr>
											...
											<%--<td class="text-center">--%>
												<%----%>
											<%--</td><a href="${pageContext.request.contextPath}/permission/findUserByIdAndAllRole?id=${p.id}" class="btn bg-olive btn-xs">添加角色</a>--%>
										<%--</tr>--%>
									</c:forEach>
								</tbody>
								<!--
